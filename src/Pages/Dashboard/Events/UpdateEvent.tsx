...
import { FaTicketAlt, FaImage, FaCalendarAlt, FaMapMarkerAlt, FaInfoCircle, FaArrowLeft } from "react-icons/fa";
...
const UpdateEvent = () => {
    ...
    useEffect(() => {
        ...
        const editableFields = [
            "title", "eventType", "eventCategory", "eventDate", "eventTime", 
            "duration", "price", "totalTickets", "maxTickets", "location", "details", "organizer"
        ];
    ...
    return (
        <div className="min-h-screen bg-gray-50/50 py-10 px-4 md:px-8">
            <div className="max-w-6xl mx-auto">
                ...
                >
                    <FaArrowLeft className="group-hover:-translate-x-1 transition-transform" /> Back to My Added Events
                </button>
                ...
                <div className="mb-10 text-center">
                    ...
                    <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-3">Modify Your Event</h2>
                    <p className="text-gray-500 max-w-xl mx-auto">Update your event details below to keep your audience informed.</p>
                </div>
                                ...
                                <div className="form-control">
                                    ...
                                    <input
                                        ...
                                        {...register("totalTickets", { 
                                            ...
                                            min: 1,
                                            validate: value => value >= (event.soldTickets || 0) || `Total tickets cannot be less than sold tickets (${event.soldTickets || 0})`
                                        })}
                                        className={`${inputClass} ${errors.totalTickets ? "border-red-500" : ""}`}
                                    />
                                    {errors.totalTickets && <span className="text-xs text-red-500 mt-1">{(errors.totalTickets as any).message}</span>}
                                </div>
