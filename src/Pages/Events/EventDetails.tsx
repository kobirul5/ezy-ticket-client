...
const EventDetails = () => {
  // Hooks and state
  const { user, darkMode, userInfo } = useAuth() as any;
  ...
  useEffect(() => {
    ...
    const updateTimer = () => {
      const now = new Date();
      const difference = new Date(eventData.eventDate).getTime() - now.getTime();
  ...
  return (
    ...
    >
      <div className="mx-auto w-11/12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-4">
          ...
          <div className="rounded-lg h-fit lg:col-span-1">
            ...
            >
              ...
              <div className="divider text-black">Starts in</div>
        ...
        {/* More Events */}
        <div className="mt-16">
          <h2 className="text-4xl font-bold text-start border-l-4 border-supporting pl-2 rounded mb-6 text-black">
            Related Events
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {suggestionsData?.slice(0, 4).map((event: any, index: number) => (
              <div
